                        ...
                        <div className="space-y-2">
                           <Button variant="secondary" className="w-full justify-start gap-3 p-2 h-auto">
                             ...
                             <div className="text-left">
                                <p className="font-semibold">Olivia Smith</p>
                           ...
                           <Button variant="ghost" className="w-full justify-start gap-3 p-2 h-auto">
                             ...
                             <div className="text-left">
                                <p className="font-semibold">James Jones</p>
                ...
                <div className="md:col-span-2 lg:col-span-3 flex flex-col">
                    <Card className="flex-1 flex flex-col">
                        <CardHeader className="border-b">
                            <CardTitle>Olivia Smith (Mathematics)</CardTitle>
                            <CardDescription>Regarding: Liam Johnson (Grade 10 - A)</CardDescription>
                        </CardHeader>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3 justify-end">
                                 ...
                                 <div className="flex items-start gap-3">
                                    <Avatar><AvatarFallback>OS</AvatarFallback></Avatar>
                                    <div className="bg-secondary p-3 rounded-lg max-w-xs">
                                        <p className="text-sm">Good morning! I'd be happy to help. The test will cover chapters 3 and 4.</p>
                                    </div>
                                </div>
                            </div>
                        </ScrollArea>
